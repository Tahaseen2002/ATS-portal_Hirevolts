...
export default function ForgotPassword() {
  ...
  const handleSendCode = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://ats-portal-hirevolts.onrender.com/api/auth/forgot-password', {
        method: 'POST',
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://ats-portal-hirevolts.onrender.com/api/auth/verify-reset-token', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://ats-portal-hirevolts.onrender.com/api/auth/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
